...
using GW.TTLtoolsBox.Core.TtlEngine.Features;
...
namespace GW.TTLtoolsBox.Core.TtlEngine
{
    ...
    public class CosyVoiceV3LYttlEngineConnector : ANetworkTtlEngineConnector
    {
        ...
        public override async Task ConnectAsync()
        {
            ...
            OnConnectionStatusChanged(TtlEngineConnectionStatus.连接中, "正在连接CosyVoice V3引擎...");
            ...
            try
            {
                ...
                OnConnectionStatusChanged(TtlEngineConnectionStatus.连接成功, "CosyVoice V3引擎连接成功");
            }
            catch (Exception ex)
            {
