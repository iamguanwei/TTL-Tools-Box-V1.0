namespace GW.TTLtoolsBox.WinFormUi.UI.Panels
{
    partial class TtlSchemePanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lab_TTL方案_当前方案详情 = new System.Windows.Forms.Label();
            ...
            this.bt_TTL方案_保存配置 = new System.Windows.Forms.Button();
            this.bt_TTL方案_还原配置 = new System.Windows.Forms.Button();
            this.dgv_TTL方案_朗读者参数配置 = new System.Windows.Forms.DataGridView();
            this.tb_TTL方案_连接参数配置 = new System.Windows.Forms.TextBox();
            ...
            this.gb_TTL方案_当前方案.Controls.Add(this.lab_TTL方案_当前方案详情);
            this.gb_TTL方案_当前方案.Controls.Add(this.lab_TTL方案_当前方案名称);
            this.gb_TTL方案_当前方案.Location = new System.Drawing.Point(6, 6);
            this.gb_TTL方案_当前方案.Name = "gb_TTL方案_当前方案";
            this.gb_TTL方案_当前方案.Size = new System.Drawing.Size(1293, 152);
            ...
            this.tb_TTL方案_当前方案详情.Name = "tb_TTL方案_当前方案详情";
            this.tb_TTL方案_当前方案详情.ReadOnly = true;
            ...
            this.cb_TTL方案_当前方案名称.Location = new System.Drawing.Point(53, 23);
            this.cb_TTL方案_当前方案名称.Name = "cb_TTL方案_当前方案名称";
            ...
            this.gb_TTL方案_配置.Controls.Add(this.bt_TTL方案_保存配置);
            this.gb_TTL方案_配置.Controls.Add(this.bt_TTL方案_还原配置);
            this.gb_TTL方案_配置.Controls.Add(this.dgv_TTL方案_朗读者参数配置);
            this.gb_TTL方案_配置.Controls.Add(this.tb_TTL方案_连接参数配置);
            this.gb_TTL方案_配置.Controls.Add(this.lab_TTL方案_朗读者参数配置);
            this.gb_TTL方案_配置.Controls.Add(this.lab_TTL方案_连接参数配置);
            this.gb_TTL方案_配置.Location = new System.Drawing.Point(6, 164);
            this.gb_TTL方案_配置.Name = "gb_TTL方案_配置";
            this.gb_TTL方案_配置.Size = new System.Drawing.Size(1293, 486);
            ...
            this.bt_TTL方案_打开角色声音预览目录.Size = new System.Drawing.Size(146, 23);
            this.bt_TTL方案_打开角色声音预览目录.TabIndex = 18;
            ...
            this.bt_TTL方案_重新加载朗读者.TabIndex = 4;
            ...
            this.bt_TTL方案_编辑配置.Size = new System.Drawing.Size(75, 39);
            this.bt_TTL方案_编辑配置.TabIndex = 3;
            ...
            this.bt_TTL方案_保存配置.Size = new System.Drawing.Size(75, 39);
            this.bt_TTL方案_保存配置.TabIndex = 3;
            ...
            this.bt_TTL方案_还原配置.Size = new System.Drawing.Size(75, 39);
            this.bt_TTL方案_还原配置.TabIndex = 3;
            ...
            this.tb_TTL方案_连接参数配置.Name = "tb_TTL方案_连接参数配置";
            ...
            this.Controls.Add(this.gb_TTL方案_当前方案);
            this.Controls.Add(this.tb_多音字替换_最终文本);
            this.Name = "TtlSchemePanel";
            this.Size = new System.Drawing.Size(1305, 656);
            this.gb_TTL方案_当前方案.ResumeLayout(false);
            this.gb_TTL方案_当前方案.PerformLayout();
        ...
        /// 当前方案分组框。
        /// </summary>
        private System.Windows.Forms.GroupBox gb_TTL方案_当前方案;

        /// <summary>
        /// 当前方案详情文本框。
        /// </summary>
        private System.Windows.Forms.TextBox tb_TTL方案_当前方案详情;

        /// <summary>
        /// 当前方案名称下拉框。
        /// </summary>
        private System.Windows.Forms.ComboBox cb_TTL方案_当前方案名称;

        /// <summary>
        /// 当前方案详情标签。
        /// </summary>
        private System.Windows.Forms.Label lab_TTL方案_当前方案详情;

        /// <summary>
        /// 当前方案名称标签。
        /// </summary>
        private System.Windows.Forms.Label lab_TTL方案_当前方案名称;

        /// <summary>
        /// 配置分组框。
        /// </summary>
        private System.Windows.Forms.GroupBox gb_TTL方案_配置;

        /// <summary>
        /// 打开角色声音预览目录按钮。
        /// </summary>
        private System.Windows.Forms.Button bt_TTL方案_打开角色声音预览目录;

        /// <summary>
        /// 自动生成全部朗读者预览音频按钮。
        /// </summary>
        private System.Windows.Forms.Button bt_TTL方案_自动生成全部朗读者预览音频;

        /// <summary>
        /// 重新加载朗读者按钮。
        /// </summary>
        private System.Windows.Forms.Button bt_TTL方案_重新加载朗读者;

        /// <summary>
        /// 编辑配置按钮。
        /// </summary>
        private System.Windows.Forms.Button bt_TTL方案_编辑配置;

        /// <summary>
        /// 保存配置按钮。
        /// </summary>
        private System.Windows.Forms.Button bt_TTL方案_保存配置;

        /// <summary>
        /// 还原配置按钮。
        /// </summary>
        private System.Windows.Forms.Button bt_TTL方案_还原配置;

        /// <summary>
        /// 朗读者参数配置表格。
        /// </summary>
        private System.Windows.Forms.DataGridView dgv_TTL方案_朗读者参数配置;

        /// <summary>
        /// 连接参数配置文本框。
        /// </summary>
        private System.Windows.Forms.TextBox tb_TTL方案_连接参数配置;

        /// <summary>
        /// 朗读者参数配置标签。
        /// </summary>
        private System.Windows.Forms.Label lab_TTL方案_朗读者参数配置;

        /// <summary>
        /// 连接参数配置标签。
        /// </summary>
        private System.Windows.Forms.Label lab_TTL方案_连接参数配置;
